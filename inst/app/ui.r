                         ...
                         div(class = "container",style="border-radius: 5px;",
                                                        ...
                                                        div(class="span6",style = "margin-left: 126px;",
                                                            ...
                                                            selectInput("Pallet", "CHM color",
                                                                        choices = c("Blues","BuGn","BuPu","GnBu","Greens","Greys",
                                                                                    ...
                                                                                    "YlOrBr","YlOrRd","BlGrRed"),selected="BlGrRed")))),
                             div(class="row-fluid", div(class="span6",
                                                        style = "margin-left: 1px;text-align:center; width:80px; color:white",
                                                        ...
                                                        div(class="span6",style = "margin-left: 82px;",
                                                            style = "margin-top:-97px; width:85px;",
                             ...
                             conditionalPanel(condition="input.filter==true",
                                              ...
                                              conditionalPanel(condition="input.filtertype=='Median'",
                                                               div(style = "margin-left: 125px;text-align:center; width:130px;margin-top:-105px;color:white",
                                                                   selectInput("wsf", "Filter Windows Size",choices = c("3x3","5x5","7x7","9x9","11x11","13x13","15x15","17x17"),selected="3x3"))),
                                                  ...
                                                  div(style = "color:white;margin-top:-10px;width:130px",
                                                      ...
                                                      div(style = "color:white;margin-top:-78px;width:130px;margin-left: 145px",
                                                          selectInput("plotSurface", "Surface",
                                                                      choices = c("solid","mesh","lines"),selected="line")),
                             ...
                             div(style="margin-left: 2px;margin-top:-15px;",
                                 ...
                                 div(style="margin-left:55px;margin-top: -33px;width:200px",
                   ...
                   tabPanel(h4(style="text-align:center;margin-top: 10px; color:white",
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(class = "container",style="border-radius: 5px;",
                            ...
                            div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 1510px; height:790px' src='legend.png'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='carlos.jpg'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                style="float: left; width: 250px;height: 260px;",
                                  ...
                                  div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='ahudak.jpg'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='leevierling.jpg'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='valbuena.jpg'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='adrian.jpg'/>"))),
                            ...
                            div(class = "container",style="border-radius: 5px;",
                                ...
                                div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='mikey.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='danilo.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='eben.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='Almeyda.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='ben.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='ajay.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='jason_drake.jpg'/>"))),


                    div(class = "container",style="border-radius: 5px;",
                        style="border: 2px solid transparent;",style="margin-left:125px;",
                        style="margin-top:5px;",style="background: white;",
                        style="float: left; width: 250px;height: 260px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='paul.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='jason_vogel.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='gabriel.jpg'/>"))),
                    ...
                    div(class = "container",style="border-radius: 5px;",
                        ...
                        div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='jeff.jpg'/>"))),
