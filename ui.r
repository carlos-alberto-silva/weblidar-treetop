      ...
      div(class = "container",style="border-radius: 5px;",
        ...
        div(class = "container",style="border-radius: 5px;",
          ...
          div(class="row-fluid", div(class="span6",
            ...
            selectInput("ws", "FWS",
              choices = c("3x3","5x5","7x7","9x9","11x11","13x13"),selected="7x7"),
    ...
    tabPanel(h4(style="text-align:center;margin-top: 10px; color:white", 
      HTML("About")),# style="background: transparent;",             
        gridster(tile.width = 250, tile.height = 250,              
          gridsterItem(col = 2, row = 3, size.x = 3, size.y = 1,style="background: white;width:845px;height: 280px",
        ...
        gridster(tile.width = 250, tile.height = 250,
                 gridsterItem(col = 2, row = 3, size.x = 1, size.y = 1,style="background: white;",style="background: white;width:280px;height: 280px",
                              h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align:center;",style="color:#003300", HTML("CNPq")),
                              div(style="text-align: center;",HTML("<a href='http://cnpq.br/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='csf.png'/>"))),
                 gridsterItem(col = 3, row = 3, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                              ...
                              div(style="text-align: center;",HTML("<a href='https://www.fs.fed.us/'a/><img style='border-radius: 5px;width: 180px; height:220px' src='usfs1_old.png'/>"))),
                 gridsterItem(col = 4, row = 3, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                              h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align: center;",style="color:#003300", HTML("University of Maryland")),
                              div(style="text-align: center;",HTML("<a href='https://www.umd.edu/'a/><img style='border-radius: 5px; width: 220px; height:220px' src='New_UMD_Globe.png'/>"))),
                  ...
                  gridsterItem(col = 5, row = 1, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                               h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align: center;",style="color:#003300", HTML("Carine Klauberg")),
                  ...
                  gridsterItem(col = 6, row = 3, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                              h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align: center;",style="color:#003300", HTML("Federal University of São João del Rei")),
                  ...
                  gridsterItem(col = 5, row = 2, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                               h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align: center;",style="color:#003300", HTML("SERDP")),
                               div(style="text-align: center;",HTML("<a href='https://www.serdp-estcp.org/'a/><img style='width: 200px;height:200px;margin-top: 5px;'' src='usfs2.jpg'/>"))),
