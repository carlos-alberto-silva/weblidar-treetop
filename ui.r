...
shinyUI(navbarPage(collapsable = FALSE, inverse = T, 
      ...
      div(class = "container",style="border-radius: 5px;",
        ...
        div(class = "container",style="border-radius: 5px;",
          ...
          div(style = "color:white",
            radioButtons("plot3Dradio", "", list("Plot 3D CHM" = "plotCHM3D",
              "Plot 3d trees" = "plot3Dtrees"),inline = TRUE)),
          div(style="margin-top:-15px;color:gray",HTML("<hr />")),             
          ...
          div(style = "margin-top: 0px; width: 200px;height: 179px;", style="color:white", HTML("SILVA, C.A; HUDAK, A.T.; CROOKSTON, N. L. and VIERLING, L. A. (2014)"))
        ),
        ...
        div(class = "container",style="border-radius: 5px;",
          ...
          div(class = "container",style="border-radius: 5px;",
            ...
            h4(style = "margin-top: 0px; width: 1000px; ",
              style="text-align: center;",style="color:#003300", 
              HTML("Canopy Height Model Profile ")),
          ...
          div(class = "container",style="border-radius: 5px;",
            ...
            style="float: left; width: 672px;height: 595px;",
              h4(style = "margin-top: 0px; width: 673px; ",
                style="text-align: center;",style="color:#003300", 
                HTML("Individual Trees Detected on the Canopy Height Model"),
 ...
 gridster(tile.width = 250, tile.height = 250,
                  ...
                  gridsterItem(col = 5, row = 1, size.x = 1, size.y = 1,style="background: white;width:280px;height: 280px",
                               h4(style = "margin-top: -5px; width: 250px;",style = "margin-bottom: 10px; width: 250px;",style="text-align: center;",style="color:#003300", HTML("Science Without Borders")),
                               div(style="text-align: center;",HTML("<a href='http://www.cienciasemfronteiras.gov.br/web/csf-eng/'a/><img style='width: 220px;height:220px' src='csf.png'/>"))),
